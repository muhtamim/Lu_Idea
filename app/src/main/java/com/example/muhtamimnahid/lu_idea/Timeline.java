...
public class Timeline extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onStart() {
        ...
        progressDialog.show();
        FirebaseRecyclerAdapter<Idea,BlogViewHolder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Idea, BlogViewHolder>(
                Idea.class,
                R.layout.idea_row,
            ...
            @Override
            protected void populateViewHolder(final BlogViewHolder viewHolder, Idea model, int position) {
    ...
    public void onClick(View v) {
        ...
        if(v==add){
            finish();
            startActivity(new Intent(getApplicationContext(),ShearIdea.class));
        }*/
    }
}
