package com.example.muhtamimnahid.lu_idea;
...
public class Myidea extends AppCompatActivity implements View.OnClickListener {
    ImageView hm,lg;
    //Button add;
    FirebaseAuth mAuth;
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Idea,Timeline.BlogViewHolder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Idea, Timeline.BlogViewHolder>(
                Idea.class,
                R.layout.idea_row,
            ...
            @Override
            protected void populateViewHolder(final Timeline.BlogViewHolder viewHolder, Idea model, int position) {
            ...
            mlikedata.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.child(key).hasChild(mauth.getCurrentUser().getUid())){
                        ...
                        Drawable d = res.getDrawable(R.drawable.upvotered);
                        lks.setBackground(d);
                        mlikedata.child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(cnt==1){
                                    textlks.setText(String.valueOf(cnt)+" Vote");
                                }
                                else{
                                    textlks.setText(String.valueOf(cnt)+" Votes");
                                }
                            }
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                        ...
                        Resources res = mview.getContext().getResources();
                        Drawable d = res.getDrawable(R.drawable.upvote);
                        lks.setBackground(d);
                        mlikedata.child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
